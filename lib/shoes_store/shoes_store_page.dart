...
import 'package:flutter_examples/shoes_store/shoes_store_detail_page.dart';
...
class _ShoesStorePageState extends State<ShoesStorePage> {
  ...
  final ValueNotifier _pageNotifier = ValueNotifier(0.0);
                ...
                Positioned(
                  ...
                  child: PageView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final double rotationY = lerpDouble(0, 90, t);
                        final translationX = lerpDouble(0, -50, t);
                        final scale = lerpDouble(0, -0.2, 0.0);
